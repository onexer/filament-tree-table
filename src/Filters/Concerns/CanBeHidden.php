...
trait CanBeHidden
{
    ...
    {
        $this->hidden(static function (HasTreeTable $livewire) use ($livewireComponents): bool {
    ...
    {
        $this->visible(static function (HasTreeTable $livewire) use ($livewireComponents): bool {
            foreach (Arr::wrap($livewireComponents) as $livewireComponent) {
                if ($livewire instanceof $livewireComponent) {
                    return true;
                }
