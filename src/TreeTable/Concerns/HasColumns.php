    ...
    public function columns(array $components): static
    {
        ...
        foreach ($this->columns as $column) {
            ...
            if (!$action instanceof Action) {
                throw new InvalidArgumentException('TreeTable column actions must be an instance of '.Action::class.'.');
            }

            $this->cacheAction($action->treeTable($this));
        }
