...
use Onexer\FilamentTreeTable\Actions\BulkActionGroup;
    ...
    public function bulkActions(array|ActionGroup $actions): static
    {
        foreach (Arr::wrap($actions) as $action) {
            ...
            if ($action instanceof ActionGroup) {
                ...
                throw new InvalidArgumentException('TreeTable bulk actions must be an instance of '.BulkAction::class.' or '.ActionGroup::class.'.');
            }
