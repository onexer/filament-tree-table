...
trait CanSearchRecords
{
    ...
    {
        return $this->getLivewire()->hasTreeTableSearch();
    }

    public function getSearchIndicator(): string
    {
        return $this->getLivewire()->getTreeTableSearchIndicator();
    }
    ...
    {
        return $this->getLivewire()->getTreeTableColumnSearchIndicators();
    }
}
