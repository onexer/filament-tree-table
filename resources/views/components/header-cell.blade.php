...
>
    ...
    @if ($sortable)
        <span class="sr-only">
                {{ __('filament-tree-table::table.sorting.fields.column.label') }}
            </span>
    @endif
    ...
    @if ($sortable)
        ...
        <span class="sr-only">
                {{ $sortDirection === 'asc' ? __('filament-tree-table::table.sorting.fields.direction.options.desc') : __('filament-tree-table::table.sorting.fields.direction.options.asc') }}
            </span>
    @endif
</{{ $sortable ? 'button' : 'span' }}>
</th>
