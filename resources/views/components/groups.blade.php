...
>
    <x-filament::dropdown
        ...
        shift
        width="xs"
        wire:key="{{ $this->getId() }}.treeTable.grouping"
        :attributes="
        ...
        <div class="grid gap-y-6 p-6">
            <label class="grid gap-y-2">
                <span class="{{ $labelClasses }}">
                    {{ __('filament-tree-table::table.grouping.fields.group.label') }}
                </span>
            ...
            <label x-cloak x-show="group" class="grid gap-y-2">
                <span class="{{ $labelClasses }}">
                    {{ __('filament-tree-table::table.grouping.fields.direction.label') }}
                </span>

                <x-filament::input.wrapper>
                    <x-filament::input.select x-model="direction">
                        <option value="asc">
                            {{ __('filament-tree-table::table.grouping.fields.direction.options.asc') }}
                        </option>

                        <option value="desc">
                            {{ __('filament-tree-table::table.grouping.fields.direction.options.desc') }}
                        </option>
                    </x-filament::input.select>
                </x-filament::input.wrapper>
            </label>
        ...
        <div class="hidden items-center gap-x-3 sm:flex">
            <label>
                ...
                <x-filament::input.wrapper>
                    ...
                    >
                        <option value="">
                            {{ __('filament-tree-table::table.grouping.fields.group.placeholder') }}
                        </option>
