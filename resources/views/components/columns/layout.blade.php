...
@php
    $getHiddenClasses = function (Onexer\FilamentTreeTable\Columns\Column | Onexer\FilamentTreeTable\Columns\Layout\Component $layoutComponent): ?string {
...
@foreach ($components as $layoutComponent)
    @php
        ...
        $isColumn = $layoutComponent instanceof \Onexer\FilamentTreeTable\Columns\Column;
    @endphp
    ...
    @if ($layoutComponent->isVisible())
        ...
        >
            @if ($isColumn)
                <x-filament-tree-table::columns.column
